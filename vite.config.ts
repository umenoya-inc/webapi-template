    ...
    overrides: [
      {
        ...
        rules: {
          ...
          "module-boundary/no-table-in-barrel-export": "error",
          "type-style/interface-for-object-types": "warn",
          "effect-structure/no-service-in-db-effect": ["error", { basePath: "src" }],
          "effect-structure/no-leaf-in-api-effect": ["error", { basePath: "src" }],
        },
      },
    ],
  },
